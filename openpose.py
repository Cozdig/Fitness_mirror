...
while cv.waitKey(1) < 0:
    ...
    # Расчет углов для правой и левой руки
    if points[BODY_PARTS["RShoulder"]] and points[BODY_PARTS["RElbow"]] and points[BODY_PARTS["RWrist"]]:
        ...
        if angle_r > 80:
            cv.putText(frame, 'Fully bent arm (right)', (50, 50), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
        else:
            cv.putText(frame, 'Bicep curl (right)', (50, 50), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
    ...
    if points[BODY_PARTS["LShoulder"]] and points[BODY_PARTS["LElbow"]] and points[BODY_PARTS["LWrist"]]:
        ...
        if angle_l > 80:
            cv.putText(frame, 'Fully bent arm (left)', (50, 100), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
        else:
            cv.putText(frame, 'Bicep curl (left)', (50, 100), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
